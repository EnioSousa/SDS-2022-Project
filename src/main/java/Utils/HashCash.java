...
public class HashCash implements Comparable<HashCash> {
    ...
    public HashCash(String cash) throws NoSuchAlgorithmException {
        ...
        try {
            ...
            throw new IllegalArgumentException("Number of leading zeros does not match the target");
        }
    }
